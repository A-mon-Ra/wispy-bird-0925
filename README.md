...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/wispy-bird-0925
```

A live public deployment of this template is available at [https://wispy-bird-0925.templates.workers.dev](https://wispy-bird-0925.templates.workers.dev)
